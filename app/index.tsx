...
import SoundCard from "@/components/SoundCard"; // ✅ CORRECT
...
/* --------------------------------------------------------
   Sleep Sounds - Gradients FIXÉS (tableaux)
-------------------------------------------------------- */
const sleepSounds = [
  {
    id: "pluie-douce",
    ...
    gradient: ["hsl(210 40% 20%)", "hsl(230 35% 15%)"],
  },
  {
    id: "vague-de-locean",
    ...
    gradient: ["hsl(195 60% 25%)", "hsl(210 50% 18%)"],
  },
  {
    id: "feu-de-camp",
    title: "Feu de camp",
    ...
    thumbnail:
      "https://pub-e001eb4506b145aa938b5d3badbff6a5.r2.dev/attachments/vr26mlk4l6oqchaekmtwk",
    gradient: ["hsl(20 60% 20%)", "hsl(10 50% 15%)"],
  },
  {
    id: "foret-paisible",
    ...
    gradient: ["hsl(140 40% 20%)", "hsl(160 35% 15%)"],
  },
  {
    id: "vent-leger",
    title: "Vent léger",
    ...
    gradient: ["hsl(180 30% 25%)", "hsl(200 30% 18%)"],
  },
  {
    id: "orage-apaisant",
    ...
    thumbnail:
      "https://images.unsplash.com/photo-1605727216801-e27ce1d0cc28?w=400&q=80",
    gradient: ["hsl(240 30% 20%)", "hsl(250 35% 15%)"],
  },
  {
    id: "riviere-calme",
    title: "Rivière calme",
    ...
    gradient: ["hsl(200 60% 20%)", "hsl(220 50% 15%)"],
  },
  {
    id: "bruit-blanc",
    title: "Bruit blanc",
    ...
    gradient: ["hsl(280 45% 22%)", "hsl(270 40% 16%)"],
  },
];

/* --------------------------------------------------------
   Frequency Images Helper
-------------------------------------------------------- */
const getFrequencyImage = (frequencyId: string): string => {
  const imageMapping: { [key: string]: string } = {
    "4-7hz":
      "https://images.unsplash.com/photo-1494233892892-84542a694e72?w=400&q=80",
    "8-12hz":
      "https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=400&q=80",
    "10hz":
      "https://images.unsplash.com/photo-1534551767192-78b8dd45b51b?w=400&q=80",
    "33hz":
      "https://images.unsplash.com/photo-1543722530-d2c3201371e7?w=400&q=80",
    "66hz":
      "https://images.unsplash.com/photo-1470790376778-a9fbc86d70e2?w=400&q=80",
    "396-hz-417-hz-639hz":
    ...
    "2772hz":
      "https://images.unsplash.com/photo-1484950763426-56b5bf172dbb?w=400&q=80",
  };

  return (
    imageMapping[frequencyId] ||
...
export default function HomeScreen() {
  ...
  const { isPlaying, currentTitle, pauseSound, stopSound, playSound } =
    useAudio();
  ...
  const getAudioUrlForSound = (soundId: string): string | number => {
    ...
    if (typeof audio === "string" || typeof audio === "number") return audio;
    return "";
  };
      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.iconContainer}>
            <Image
              source={{
                uri: "https://pub-e001eb4506b145aa938b5d3badbff6a5.r2.dev/attachments/uiamvomi7oant6plfs9c6",
              }}
              style={styles.logo}
              resizeMode="contain"
            />
          ...
          <Text style={styles.subtitle}>
            Plongez dans un sommeil paisible avec des sons apaisants et des
            fréquences relaxantes
          </Text>
        </View>
        ...
        <View style={styles.sectionButtons}>
          ...
          <TouchableOpacity
            style={[
              styles.sectionButton,
              activeSection === "frequencies" && styles.sectionButtonActive,
            ]}
            ...
            {healingFrequencies.map((freq) => (
              <View key={freq.id} style={styles.gridItem}>
                <SoundCard
                  ...
                  thumbnail={getFrequencyImage(freq.id)}
                  gradient={[
                    `${freq.color}cc`,
                    `${freq.color}99`,
                    "#000000ee",
                ...
                <TouchableOpacity
                  onPress={async () => {
                    if (isPlaying) pauseSound();
                      ...
                      const s = soundsConfig.find(
                        (x) => x.title === currentTitle
                      );
                      const f = healingFrequencies.find(
                        (x) => x.title === currentTitle
                      );

                      if (s && typeof s.audio === "string")
                        playSound(s.audio, s.title);
                      else if (f && typeof f.audioUrl === "string")
                        playSound(f.audioUrl, f.title);
                    }
                  }}
